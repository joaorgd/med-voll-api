...
@AutoConfigureJsonTesters // 1. Anotação para injetar o JacksonTester
public class ConsultaControllerTest {

    @Autowired
    private MockMvc mvc;

    // 2. Injeta os helpers para converter objetos em JSON
    @Autowired
    ...
    // 3. Mocka a camada de serviço para não executar a lógica de negócio real
    @MockBean
    ...
    void agendar_cenario2() throws Exception {
        ...
        // 4. CORREÇÃO: Verifica se o status é 201 Created
